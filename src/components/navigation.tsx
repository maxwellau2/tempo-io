...
import { APP_CONFIG, TIMER_INTERVALS, TIME_UNITS } from '@/lib/constants';
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={item.href}
                className={`
                  flex flex-col items-center justify-center gap-1 py-2 px-3 text-xs font-medium transition-colors min-w-[60px]
                  ${isActive
